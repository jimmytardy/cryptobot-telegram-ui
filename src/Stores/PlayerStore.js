...
import { AUDIO_MIN_BUFFERED_TIME_S, CHAT_IDS_AUTHORIZED, PLAYER_PLAYBACKRATE_MAX, PLAYER_PLAYBACKRATE_NORMAL, PLAYER_PRELOAD_MAX_SIZE, PLAYER_PRELOAD_PRIORITY, PLAYER_VOLUME_MAX, PLAYER_VOLUME_MIN, PLAYER_VOLUME_NORMAL } from '../Constants';
...
class PlayerStore extends EventEmitter {
    ...
    if (update && update.source && update.source.chat_id && !CHAT_IDS_AUTHORIZED.includes(update.source.chat_id)) return;
