...
import { CHAT_IDS_AUTHORIZED, GROUP_CALL_AMPLITUDE_ANALYSE_INTERVAL_MS, GROUP_CALL_PARTICIPANTS_LOAD_LIMIT } from '../Constants';
...
class CallStore extends EventEmitter {
    ...
    onUpdate = async update => {
        if (update && update.chat_id && !CHAT_IDS_AUTHORIZED.includes(update.chat_id)) return;
        switch (update['@type']) {
